...
const petData = {
  ...
  frog: {
    name: 'frog',
    image: '/images/pets/frog.png',
    color: 'from-green-400 to-teal-500',
    message: 'Hi! I\'m frog. I monitor all kinds of trades for you and will let you know when I spot a significant large one.'
  }
}

type PetKey = keyof typeof petData;

export default function AlertSetupClient() {
  ...
  if (!selectedPet) {
    // 这个 return 会被 Suspense 的 fallback UI 替代，但我们仍然保留它作为健壮性措施
    return null;
  }
